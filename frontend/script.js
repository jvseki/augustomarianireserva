...
// Cabeçalho: [Horário, Segunda, Terça, Quarta, Quinta, Sexta]
// col 2 = Segunda (dia 1), col 3 = Terça (dia 2), …, col 6 = Sexta (dia 5)
...
function calcularUsoPorColuna(dados) {
  ...
  const uso = {};
  for (let col = 2; col <= 6; col++) uso[col] = { tablet: 0, prata: 0, preto: 0 };
